...
```{r Corr_PCG, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Number of TFBS and targets of predicted and non-predicted protein-coding genes.", fig.height = 10, fig.width = 8, fig.align = "center"}
...
# names(analyzed.genes.cohort.list)
...
```{r eCDF_plot1_pcg, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Empirical Cumulatide Distribution Functions of number of TFBS, number of targets and number of mutations in protein-coding genes. (Part 1)", fig.height = 10, fig.width = 8, fig.align = "center"}
...
```{r eCDF_plot2, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Empirical Cumulatide Distribution Functions of number of TFBS, number of targets and number of mutations in protein-coding genes. (Part 2)", fig.height = 10, fig.width = 8, fig.align = "center"}
...
```{r Corr_miRNA, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Number of TFBS and targets of predicted and non-predicted protein-coding genes.", fig.height = 10, fig.width = 8, fig.align = "center"}
...
```{r eCDF_plot1_miRNA, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Empirical Cumulatide Distribution Functions of number of TFBS, number of targets and number of mutations in miRNA genes. (Part 1)", fig.height = 10, fig.width = 8, fig.align = "center"}
...
```{r eCDF_plot2_miRNA, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Empirical Cumulatide Distribution Functions of number of TFBS, number of targets and number of mutations in miRNA genes. (Part 1)", fig.height = 10, fig.width = 8, fig.align = "center"}
