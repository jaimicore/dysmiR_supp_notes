...
```{r Nb_TFBS_per_gene, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE }
...
TFBS.distr.ecdf.plot <- ggplot(Nb.TFBSs.per.gene.classes, aes(x = Nb_TFBS, colour = Class)) +
        ...
        labs(x = "Nb of TFBSs assigned to genes", y = "ECDF", title = "Distribution of TFBSs among predicyed and non-predicted genes")
...
enriched.terms.gg <- plot_grid(TFBS.distr.ecdf.plot,
                               ...
                               ncol = 2, align = "hv", labels = c('A)', 'B)', "C)", "D)"), label_size = 15,
