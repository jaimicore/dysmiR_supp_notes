...
<!-- load("TFBS_vs_Exonic_mutations/Analysis_samples_w_TFBS_Exonic_mutations.rdata")  -->
<!-- tfbs.vs.exon.mutations <- aa -->
...
<!-- # agg.net.ucec <- agg.net + add_space -->



<!-- load("Indiv_nets/BRCA-US/Aggregated_network_BRCA-US.Rdata")  -->
<!-- agg.net.brca <- agg.net + add_space -->

<!-- load("Indiv_nets/HNSC-US/Aggregated_network_HNSC-US.Rdata")  -->
<!-- agg.net.hnsc <- agg.net + add_space -->

<!-- load("Indiv_nets/LIHC-US/Aggregated_network_LIHC-US.Rdata")  -->
<!-- agg.net.lihc <- agg.net + add_space -->

<!-- load("Indiv_nets/LUAD-US/Aggregated_network_LUAD-US.Rdata")  -->
<!-- agg.net.luad <- agg.net + add_space -->

<!-- load("Indiv_nets/LUSC-US/Aggregated_network_LUSC-US.Rdata")  -->
<!-- agg.net.lusc <- agg.net + add_space -->

<!-- load("Indiv_nets/STAD-US/Aggregated_network_STAD-US.Rdata")  -->
<!-- agg.net.stad <- agg.net + add_space -->




<!-- suppressMessages(plot_grid(agg.net.brca, -->
<!--                            agg.net.hnsc, -->
...
<!-- \pagebreak -->
<!-- ```{r FEA_KEGG_2019, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Functional enrichment (KEGG 2019) analysis considering dysregulated genes in the networks of predicted miRNA and protein-coding genes. The heatmaps represent the significance (-log$_{10}$(P-value)) of the most enriched terms (rows) associated to the dysregulated genes found on the seven analyzed cohorts (columns) when considering protein-coding genes with LoF mutations (PCGs::LoF; top-left), protein-coding genes with cis-regulatory mutations (PCG::TFBS; top-right), and miRNAs with cis-regulatory mutations (miRNAs::TFBS; bottom-right). The terms are ordered by their mean ranks across the cohorts.", fig.height = 70, fig.width = 60, fig.align = "center"} -->
...
<!-- \pagebreak -->
<!-- \begin{landscape} -->
<!-- ```{r miRNAs_predictec_pancancer, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="miRNAs predicted by xseq in the seven TCGA cohorts. Cell colors indicate the posterior probability computed over the corresponding cohort. Red stars indicate that the miRNA is annotated as a cancer miRNA in miRCancer. Blue stars indicate that the miRNA was reported as a cancer miRNA in the specific cancer type where it is predicted by xseq, according to miRCancer annotation.", out.width = "650px", out.height = "700px", fig.align = "center"} -->

<!-- knitr::include_graphics("Highlighted_genes_pancancer/miRNAs_pancancer.png", dpi = 100) -->
<!-- ``` -->
<!-- \end{landscape} -->
...
<!-- <!-- \pagebreak --> -->
<!-- <!-- ```{r Fraction_dysreg_nets_2, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Fraction of the original gene networks predicted as dysregulated for the predicted driver genes in A) LUSC-US, B) STAT-US, and C) UCEC-US. X-axis corresponds to the number of dysregulated genes in the filtered network (see Material and methods), Y-axis corresponds to the original size of the gene networks before any filtering (for expression). Color scale corresponds to the fraction of the network that is predicted to be dysregulated in the samples with corresponding mutations of interest.", fig.height = 35, fig.width = 31, fig.align = "center"} --> -->
...
<!-- <!-- ## Combine plots --> -->
<!-- <!-- up_row <- plot_grid(plot.list[["LUSC"]], plot.list[["STAD"]], labels = c('A)', 'B)'), label_size = 37, label_colour = "black", hjust = 0, vjust = 1, rel_heights = c(1),ncol = 2) --> -->

<!-- <!-- plot_grid(up_row, plot.list[["UCEC"]], labels = c('', 'C)'), label_size = 37, label_colour = "black", hjust = 0, vjust = 1, nrow = 2) --> -->
...
<!-- ## KEGG TFBS PCG -->
<!-- gene.names <- GSEA.enrich.plots[["KEGG_2019_Human"]][["PCG.TFBS"]][["gene_names"]] -->
<!-- basis.pcg.tfbs.kegg <- GSEA.enrich.plots[["KEGG_2019_Human"]][["PCG.TFBS"]][["plot"]] -->
