...
<!--             nrow = 1, labels = c('A)', 'B)'), -->
<!--             align = "hv", -->
<!--             label_size = 30, vjust = 1.25, hjust = -1, rel_widths = c(1, 1)) -->
...
\pagebreak
```{r Breast_Cancer_agg_net, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Network representing the predicted protein-coding genes in BASIS (all samples), BASIS ER+, ER- and BRCA-US cohorts. The name of the genes predicted in two or more cohorts are displayed many times with different colors.", out.width = "700pt", out.height="470pt", fig.align = "center"}
...
mirna.in.cohort.list <- sapply(selected.mirna.list, function(x){
                          x[grepl(x, pattern = "::")]
                        })
```
