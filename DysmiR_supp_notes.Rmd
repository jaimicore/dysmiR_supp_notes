...
```{r Breast_Cancer_agg_net, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Network representing the predicted protein-coding genes in BASIS (all samples), BASIS ER+, ER- and BRCA-US cohorts. The name of the genes predicted in two or more cohorts are displayed many times with different colors.", fig.height = 14, fig.width = 18, fig.align = "center", message=FALSE, warning=FALSE}
...
\pagebreak
\begin{landscape}
```{r miRNA_brca_ER_plot, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="Predicted miRNA drivers in breast cancer cohorts. Predicted miRNAs in TCGA (BRCA-US) and BASIS (all samples and ER- samples only). The pie plots represent the distribution of samples with ER-/+ status.", out.width = "675pt", out.height = "900pt", fig.align = "center", message=FALSE, warning=FALSE}
