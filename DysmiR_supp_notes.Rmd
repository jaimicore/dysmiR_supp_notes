...
## NOTE: the variable barplot$C has the plot displayed in Figure 2B
```
...
<!-- # ```{r Figure3, cache=TRUE, include=TRUE, echo=FALSE, eval=TRUE, fig.cap="", fig.height = 18, fig.width = 15, fig.align = "center"} -->
<!-- #  -->
<!-- #  -->
<!-- #  cohorts <- c("BRCA", "HNSC", "LIHC", "LUAD", "LUSC", "STAD", "UCEC") -->
<!-- #  -->
...
<!-- #                                  scale_fill_distiller(palette = "Oranges", direction = +1, na.value = "white", name = "Number of genes in luster") + -->
...
<!-- ```{r FEA_KEGG_2021_Fig4, cache=TRUE, include=FALSE, echo=FALSE, eval=TRUE} -->
